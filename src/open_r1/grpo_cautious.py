...
def main(script_args, training_args, model_args):
    ...
    scheduler = get_cosine_with_min_lr_schedule_with_warmup(optimizer, int(training_args.warmup_ratio * num_training_steps), num_training_steps, last_epoch = -1, min_lr_rate = training_args.lr_scheduler_kwargs["min_lr_rate"])
    trainer = GRPOTrainer(
        model=model,
